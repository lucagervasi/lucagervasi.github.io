# Baby Adventures Interattiva — Avventura a stickers "Drago e Castello"
...
game master** che conduce il gioco **dal vivo, un turno alla volta**: inventa
una storia dolce per bimbi di **4 anni**, suggerisce **quali stickers spostare**
sul tabellone di carta *Dragon and Castle*, fa una domanda e **aspetta la
risposta** prima di andare avanti.

![Il tabellone Dragon and Castle](../board-reference.png)

> Se invece preferisci **raccontare tu** la storia, usa la skill
> **[`baby-adventures`](../baby-adventures/)**: ti prepara il copione completo
> (trama, cosa dire e quali stickers muovere) da leggere prima di giocare.
...
1. Copia sul telefono la cartella `baby-adventures-interattiva` (basta il file
   `SKILL.md`).
...
1. Apri **AI Chat** e scrivi: **`inizia avventura`**
   (vanno bene anche *"avventura interattiva"*, *"giochiamo al drago e
   castello"* o *"giochiamo insieme"*).
